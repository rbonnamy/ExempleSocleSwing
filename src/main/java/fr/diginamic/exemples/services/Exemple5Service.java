...
import fr.diginamic.exemples.daos.PersonneDao;
import fr.diginamic.exemples.entites.Personne;
...
public class Exemple5Service extends MenuService {
	...
	public Exemple5Service() {
		...
		EntityManager em = ApplicationExemple.emf.createEntityManager();
	...
	public void traitement() {
		...
		console.printAlign("Ajouter un client",
